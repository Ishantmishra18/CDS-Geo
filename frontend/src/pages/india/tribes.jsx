...
import { tribeList } from "../../data/india.js";
...
const Parks = () => {
  ...
  useEffect(() => {
    ...
    const shuffled = [...tribeList].sort(() => Math.random() - 0.5);
    setParks(shuffled);
  ...
  const nextQuestion = () => {
    ...
    if (nextIndex < parks.length) {
      ...
      const reshuffled = [...tribeList].sort(() => Math.random() - 0.5);
      setParks(reshuffled);
      setIndex(0);
  ...
  return (
    <div className="flex flex-col md:flex-row p-4 gap-6">
      ...
      <AboutCard
        img={question?.image}
        question={"this Tribe belongs to which state"}
